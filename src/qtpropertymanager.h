 ...
 */
class QT_QTPROPERTYBROWSER_EXPORT TablePropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
    ...
    void setSelectedModel(QtProperty* property, QItemSelectionModel* selectionModel);
    QItemSelectionModel* selectedModel(QtProperty* property);
 ...
 */
class QT_QTPROPERTYBROWSER_EXPORT LineEditWithButtonPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
 ...
 */
class QT_QTPROPERTYBROWSER_EXPORT TextEditPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
 ...
 */
class QT_QTPROPERTYBROWSER_EXPORT EnumMapPropertyManager : public QtAbstractPropertyManager
{
    Q_OBJECT
public:
