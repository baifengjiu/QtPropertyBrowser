...
void TablePropertyManager::setSelectedModel(QtProperty* property, QItemSelectionModel* selectionModel)
{
    propertyToValue_[property].selectionModel = selectionModel;
}

QItemSelectionModel* TablePropertyManager::selectedModel(QtProperty* property)
{
    const auto& data = propertyToValue_.value(property);
    return data.selectionModel;
}
QModelIndex TablePropertyManager::selectedIndex(QtProperty* property)
{
    const auto& data = propertyToValue_.value(property);
    return data.selectionModel->currentIndex();
}
